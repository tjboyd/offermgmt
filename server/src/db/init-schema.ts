/**
 * init-schema.ts
 * Runs at startup (or manually) to create all tables if they don't exist.
 * Uses raw pg client so it works in production without drizzle-kit.
 */
...
-- App config (key-value store for integrations, branding, etc.)
